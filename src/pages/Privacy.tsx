      ...
      <div className="mx-auto w-full max-w-app flex-1 px-5 py-6 lg:max-w-[720px] lg:px-6 lg:py-10">
        ...
        <Card className="mt-4 border-warning/40 bg-warning-bg/40 lg:mt-6">
          ...
          <p className="mt-1 text-[11px] leading-relaxed text-text-gray">
            이 문서는 ZIPUP 서비스 이해를 돕기 위한 참고용 템플릿이며, 변호사 등 전문가의 법률 자문을 대체하지
            않습니다. 실제 서비스 운영 및 개인정보보호법 등 관계 법령 준수를 위해서는 반드시 법률 전문가의 검토를
            받아 확정해주세요.
          </p>
        </Card>
        ...
        <div className="mt-4 flex flex-col gap-5 lg:mt-6">
          <Section title="1. 수집하는 개인정보 항목">
            <ul className="flex flex-col gap-1">
              ...
              <li>· 심리 가드(가스라이팅 분석) 기능에 입력한 채팅·문자 내용 및 캡처 이미지</li>
          ...
          <Section title="2. 개인정보 수집 및 이용 목적">
            <p>
              수집한 정보는 전세사기 위험도 분석 및 심리 조작(가스라이팅) 패턴 분석 서비스를 제공하기 위한 목적으로만
              사용됩니다. 구체적으로는 회원 식별 및 로그인 유지, AI 기반 위험도 분석 결과 생성, 분석 이력 조회 기능
              제공, 서비스 품질 개선을 위한 통계 분석에 활용됩니다.
            </p>
          </Section>

          <Section title="3. 개인정보의 제3자 제공">
            <p className="mb-1.5">
              회사는 원칙적으로 이용자의 개인정보를 외부에 제공하지 않으나, 아래의 경우 분석 서비스 제공을 위해
              필요한 최소한의 정보를 제3자에게 전달합니다.
            </p>
            <ul className="flex flex-col gap-1">
              <li>
                · <span className="font-medium text-text-dark">Google Gemini API (Google LLC)</span> — 업로드된
                계약서/등기부등본 및 심리 가드 채팅 내용을 AI 위험도 분석 목적으로 전달
              </li>
              <li>
          ...
          <Section title="4. 개인정보의 보관 및 삭제">
            <p>
              이용자의 개인정보는 회원 탈퇴 시 지체 없이 파기됩니다. 계약서 스캔 및 심리 가드 분석 이력을 포함한
              관련 데이터 역시 회원 탈퇴와 함께 함께 삭제되며, 별도로 다운로드하거나 백업해두지 않은 데이터는
              복구할 수 없습니다. 관계 법령에 따라 일정 기간 보관이 필요한 정보가 있는 경우 해당 법령에서 정한
              기간 동안 별도 보관 후 파기합니다.
            </p>
          </Section>
          ...
          <Section title="5. 이용자의 권리">
            <p>
              이용자는 언제든지 프로필 화면에서 본인의 분석 이력을 조회할 수 있으며, 회원탈퇴를 통해 본인의 개인정보
              및 관련 데이터 삭제를 요청할 수 있습니다. 그 밖의 문의사항은 고객센터를 통해 접수해주세요.
            </p>
          </Section>
        </div>
      </div>
